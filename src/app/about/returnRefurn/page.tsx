...
const page = () => {
  return (
    <div className="return-refund-policy mx-auto max-w-5xl p-6 sm:my-20 my-16">
      <h1 className="mb-6 text-3xl font-bold">Return and Refund Policy</h1>

      <section className="mb-8">
        <p className="mb-4">Thank you for shopping at Printustaad.</p>
        <p className="mb-4">
          ...
          and Refund Policy has been created with the help of the Free Return
          and Refund Policy Generator.
        </p>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          <li>
            ...
            or Our in this Agreement) refers to Printustaad, Delhi.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Printustaad, accessible from
            Printustaad.com
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>
            By email:{" "}
            <a
              href="mailto:printustaadofficial@gmail.com"
              className="text-blue-600 hover:underline"
            >
              printustaadofficial@gmail.com
            </a>
          </li>
        </ul>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="mb-4 text-2xl font-semibold">Conditions for Returns</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="mb-4 text-2xl font-semibold">Gifts</h2>
        <p className="mb-4">
          If the Goods were marked as a gift when purchased and then shipped
          directly to you, You will receive a gift credit for the value of your
          return. Once the returned product is received, a gift certificate will
          be mailed to You.
        </p>
        <p className="mb-4">
          If the Goods were not marked as a gift when purchased, or the gift
