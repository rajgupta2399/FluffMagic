  ...
  return (
    <div className="privacy-policy-container mx-auto my-16 max-w-5xl p-6 sm:my-20">
      ...
      <section className="mb-8">
        ...
        <h3 className="mb-2 text-xl font-medium">Business Transactions</h3>
        <p className="mb-4">
        ...
        <h3 className="mb-2 text-xl font-medium">Law enforcement</h3>
        <p className="mb-4">
        ...
        <h3 className="mb-2 text-xl font-medium">Other legal requirements</h3>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="mb-4 text-2xl font-semibold">Children Privacy</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          that third party site. We strongly advise You to review the Privacy
